...
(sudo apt-get install -y openjdk-8-jdk && ln -s /usr/lib/jvm/java-8-openjdk-amd64 /opt/dev/apps/links/openjdk8 && ln -s /opt/dev/apps/links/openjdk8 /opt/dev/apps/links/jdk8 &&  && ln -s /opt/dev/apps/links/jdk8 /opt/dev/apps/links/jdk)
